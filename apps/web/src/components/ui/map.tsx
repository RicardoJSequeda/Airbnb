  ...
  useEffect(() => {
    ...
    const styleDataHandler = () => {
      ...
      styleTimeoutRef.current = setTimeout(() => {
        ...
        if (projection && typeof (map as MapLibreGL.Map & { setProjection?: (p: MapLibreGL.ProjectionSpecification) => void }).setProjection === "function") {
          (map as MapLibreGL.Map & { setProjection: (p: MapLibreGL.ProjectionSpecification) => void }).setProjection(projection);
        }
      }, 100);
    };
